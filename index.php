...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color:#F4FCD9;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../component/login_page.php">Area</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="./component/form_daftar.php">Daftar Baru</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="./component/view.php">Pendaftar</a>
  </li>
